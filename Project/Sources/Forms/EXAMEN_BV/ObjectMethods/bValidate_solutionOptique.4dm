If (Form event code:C388=On Clicked:K2:4)
	...
	antecedentAideVisuelle.Nom:=aideAnamnese_nom
	antecedentAideVisuelle.Distance:=aideAnamnese_distance
	antecedentAideVisuelle.Utilisation:=aideAnamnese_utilisation
	antecedentAideVisuelle.Commentaire:=aideAnamnese_commentaire
	antecedentAideVisuelle.Date:=aideAnamnese_date
	antecedentAideVisuelle.Description:=aideAnamnese_description
	
	antecedentAideVisuelle.save()
