If (FORM Event:C1606.code=On Load:K2:1)
	...
	// Nouvelle entité dans la table ESSAI_AIDE_VISUELLE
	essaiAideVisuelle:=ds:C1482.ESSAI_AIDE_VISUELLE.new()
	essaiAideVisuelle.ID_EXAMEN_COMPLEMENTAIRE:=examenComplementaire.ID
	
	// Nouvelle entité dans la table SCORE_QUALITE_VIE
	scoreQualiteVie:=ds:C1482.SCORE_QUALITE_VIE.new()
	scoreQualiteVie.ID_EXAMEN_COMPLEMENTAIRE:=examenComplementaire.ID
